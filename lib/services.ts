...
export const SERVICES: Array<Service> = [
  {
    ...
    description: "Profesionálne a bezpečné demolačné práce všetkých typov objektov. Zabezpečujeme kompletnú prípravu, realizáciu a likvidáciu odpadu s ohľadom na životné prostredie.",
    icon: Hammer,
  } satisfies Service,
  {
    id: "2",
  ...
  } satisfies Service,
  {
    ...
    description: "Kvalitné murárske práce pre novostavby, rekonštrukcie a opravy. Stavby z tehál, tvárnic a iných materiálov realizujeme s dôrazom na detail a trvácnosť.",
    icon: Cuboid,
  } satisfies Service,
  {
    id: "4",
