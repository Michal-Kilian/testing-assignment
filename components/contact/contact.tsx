...
export const Contact = () => {
  ...
  return (
    <section id="contactSection" className="w-full flex flex-col items-center justify-center p-6">
      <Card className="w-full flex flex-row justify-between">
        <CardHeader className="w-1/2 flex flex-col items-start justify-start">
          <CardTitle
        ...
        <CardContent
          className="w-1/2 flex items-center justify-center flex-row gap-6 px-6 transition-all duration-200">
                ...
                <form>
                  ...
                  >
                            ...
                            <SelectContent className="w-full">
                              {SERVICES.map((service: Service) => (
                                <SelectItem
                                  key={service.id}
                                  value={service.id}
                                  className="cursor-pointer hover:bg-accent flex flex-row items-center justify-start gap-x-2"
                                >
                                  <service.icon/>
                                  {service.title}
                                </SelectItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Textarea
                                ...
                                className="resize-none pl-9 pt-2 min-h-24"
                                {...field}
                              />
                            </div>
                          </FormControl>
                    ...
                    <Button
                      ...
                      disabled={Object.keys(form.formState.touchedFields).length === 0}
                    >
                      {submitPending ? <Loader2 className="animate-spin" /> : <Send />}
